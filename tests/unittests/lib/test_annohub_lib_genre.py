...
class TestCreate(unittest.TestCase):
    ...
    def test_create(self):
        this_genre = genre.create(self.this_name, self.this_title)
        self.assertTrue(bson.objectid.ObjectId.is_valid(this_genre))
        this_genre = genre.create(self.this_name, self.this_title)
        self.assertIsNone(this_genre)
...
# self.assertEqual(expected, get_by_name(genre))
# assert False # TODO: implement your test here
#
# class TestGetById(unittest.TestCase):
#    def test_get_by_id(self):
# self.assertEqual(expected, get_by_id(genre_id))
# assert False # TODO: implement your test here
#
